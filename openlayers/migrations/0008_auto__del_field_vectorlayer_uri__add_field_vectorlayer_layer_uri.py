...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VectorLayer.layer_uri'
        db.add_column('openlayers_vectorlayer', 'layer_uri', self.gf('django.db.models.fields.CharField')(max_length=300, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VectorLayer.layer_uri'
        db.delete_column('openlayers_vectorlayer', 'layer_uri')
